...
TERM._PartsGroupMaybeSingle = TERM.emit(
	TERM.list([
		TERM.string("["),
		TERM.maybe(TERM.gap),
		TERM.term("_Part"),
...
TERM._PartsGroupMaybeMulti = TERM.emit(
	TERM.list([
		TERM.string("["),
		TERM.maybe(TERM.gap),
		TERM.newline,
	...
	([b, g1, nl, g2, part]) => `TERM.maybe(TERM.list([\n	${part.output}\n]))`,
)
...
TERM._PartGapShorthand = TERM.emit(
	TERM.string("_"),
	() => `TERM.gap`,
)
